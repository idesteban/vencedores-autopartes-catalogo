...
(function () {
  ...
  function renderTypes() {
    ...
    if (!types.length) {
      el.body.innerHTML =
          '<div class="empty-state"><p>Aún no hay pedales, guardapolvos o fuelles amarrados a esta línea. Consulte por WhatsApp.</p><a class="btn btn-wa" target="_blank" rel="noopener" href="' +
        C.waUrl(
